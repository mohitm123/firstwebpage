...
var iCurrentSpeed = 0, iTargetSPeed = 0,bDecrement = null,job = null;
...
function drawLargeTickMarks(options) {
    ...
    for (iTick = 0; iTick < 180; iTick += 20) {
...
function drawSpeedometerColourArc(options) {
    ...
    drawSpeedometerPart(options, 1.0, "green", startOfGreen);
    drawSpeedometerPart(options, 0.9, "orange", endOfGreen);
    drawSpeedometerPart(options, 0.9, "red", endOfOrange);
...
function clearCanvas(options) {
    options.ctx.clearRect(0, 0, 1000, 800);
    applyDefaultContextSettings(options);
}
